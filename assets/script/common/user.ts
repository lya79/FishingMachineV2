...
export class User {
    ...
    public static setTowerMode(towerMode: number) {
        this.towerMode = towerMode;
    }

    public static getTowerMode(): number {
